...
class PyMdanalysis(PythonPackage):
    ...
    pypi = "MDAnalysis/MDAnalysis-2.0.0.tar.gz"
    
    version('2.0.0',  sha256='bf9c9b7a03404e65aad66215d4c2ff8834ab747551eeaee059ff3e599a99d322')
    ...
    depends_on('python@2.7:', when='@0.15.0:1.0.0', type=('build', 'run'))
    depends_on('python@3.9.12:', when='@2.0.0:', type=('build', 'run'))
    ...
    depends_on('py-numpy@1.21.6:', when='@:2.0.0',       type=('build', 'run'))
    ...
    depends_on('py-griddataformats@0.4:',   when='@0.17.0:1.0.0', type=('build', 'run'))
    depends_on('py-griddataformats@0.5:',   when='@2.0.0:', type=('build', 'run'))
    
    depends_on('py-matplotlib',        when='@:0.15.0+analysis',       type=('build', 'run'))
    depends_on('py-matplotlib',        when='@2.0.0:+analysis',       type=('build', 'run'))
    depends_on('py-matplotlib',        when='@2.0.0:',       type=('build', 'run'))
    depends_on('py-matplotlib@1.5.1:', when='@0.16.0:0.16.1+analysis', type=('build', 'run'))
    depends_on('py-matplotlib@1.5.1:', when='@0.16.2:1.0.0',                type=('build', 'run'))
    
    depends_on('py-scipy',        when='@:0.16.1+analysis', type=('build', 'run'))
    depends_on('py-scipy@1.8.0:',   when='@2.0.0:+analysis', type=('build', 'run'))
    depends_on('py-scipy@1.8.0:',   when='@2.0.0:', type=('build', 'run'))
    ...
    depends_on('py-fasteners', type=('run'))
